...
$EndSheet
Text Notes 2950 650  0    100  ~ 20
DCDC
Text Label 5900 1000 2    50   ~ 0
~RST~
Wire Notes Line
	2850 500  2850 1650
Text Notes 4400 650  0    100  ~ 20
DEBUG
Wire Wire Line
	5550 1000 5900 1000
Wire Wire Line
...
F 0 "#PWR034" H 4550 1050 50  0001 C CNN
F 1 "+3.3V" V 4550 1300 50  0000 L CNN
...
F 0 "#PWR035" H 5550 650 50  0001 C CNN
F 1 "GND" V 5550 700 50  0000 C CNN
...
F 1 "GND" V 4850 700 50  0000 C CNN
...
F 0 "J4" H 5200 1525 50  0000 C CNN
F 1 "SWDEBUG_CONN" H 5200 1434 50  0000 C CNN
F 2 "Connector_IDC:IDC-Header_2x05_P2.54mm_Vertical" H 5150 650 50  0001 C CNN
...
U 1 1 6206495F
P 8600 1200
F 0 "J5" H 8650 1417 50  0000 C CNN
F 1 "BRAKELIGHT" H 8650 1326 50  0000 C CNN
F 2 "Connector_Molex:Molex_Micro-Fit_3.0_43045-0400_2x02_P3.00mm_Horizontal" H 8600 1200 50  0001 C CNN
...
U 1 1 6206504B
P 8400 1200
F 0 "#PWR036" H 8400 1050 50  0001 C CNN
F 1 "+12V" V 8415 1328 50  0000 L CNN
...
F 0 "J12" H 8250 4300 50  0000 C CNN
F 1 "SD" H 8250 4200 50  0000 C CNN
F 2 "Connector_Molex:Molex_Micro-Fit_3.0_43650-0200_1x02_P3.00mm_Horizontal" H 8100 4300 50  0001 C CNN
...
U 1 1 61EC1C59
P 2200 1350
F 0 "#PWR0143" H 2200 1200 50  0001 C CNN
F 1 "+12V" V 2215 1478 50  0000 L CNN
F 2 "" H 2200 1350 50  0001 C CNN
F 3 "" H 2200 1350 50  0001 C CNN
	1    2200 1350
	0    1    1    0   
...
F 1 "GND" V 2205 1322 50  0000 R CNN
...
$EndComp
$Comp
L Eagle_Main:Tex_DCDC_v2 U1
U 1 1 61E72324
P 3300 750
F 0 "U1" H 3628 401 50  0000 L CNN
F 1 "Tex_DCDC_v2" H 3628 310 50  0000 L CNN
F 2 "Eagle_Main:Tex_DCDC_v2_horizontal" H 3200 750 50  0001 C CNN
...
U 1 1 61E72AA5
P 3200 850
AR Path="/61A00C0D/61E72AA5" Ref="#PWR?"  Part="1" 
AR Path="/61E72AA5" Ref="#PWR026"  Part="1" 
F 0 "#PWR026" H 3200 700 50  0001 C CNN
F 1 "+3.3V" V 3200 950 50  0000 L CNN
...
U 1 1 61E72F16
P 3200 1150
AR Path="/61A00C0D/61E72F16" Ref="#PWR?"  Part="1" 
AR Path="/61E72F16" Ref="#PWR031"  Part="1" 
F 0 "#PWR031" H 3200 1000 50  0001 C CNN
F 1 "+5V" V 3200 1250 50  0000 L CNN
...
U 1 1 61E735D3
P 3200 1250
AR Path="/61A00C0D/61E735D3" Ref="#PWR?"  Part="1" 
AR Path="/61E735D3" Ref="#PWR032"  Part="1" 
F 0 "#PWR032" H 3200 1100 50  0001 C CNN
F 1 "+5V" V 3200 1350 50  0000 L CNN
...
U 1 1 61E73DB6
P 3200 950
AR Path="/61A00C0D/61E73DB6" Ref="#PWR?"  Part="1" 
AR Path="/61E73DB6" Ref="#PWR029"  Part="1" 
F 0 "#PWR029" H 3200 700 50  0001 C CNN
F 1 "GND" V 3200 850 50  0000 R CNN
...
U 1 1 61E74296
P 3200 1050
AR Path="/61A00C0D/61E74296" Ref="#PWR?"  Part="1" 
AR Path="/61E74296" Ref="#PWR030"  Part="1" 
F 0 "#PWR030" H 3200 800 50  0001 C CNN
F 1 "GND" V 3200 950 50  0000 R CNN
...
U 1 1 61E74411
P 3200 1350
AR Path="/61A00C0D/61E74411" Ref="#PWR?"  Part="1" 
AR Path="/61E74411" Ref="#PWR0144"  Part="1" 
F 0 "#PWR0144" H 3200 1100 50  0001 C CNN
F 1 "GND" V 3200 1250 50  0000 R CNN
...
U 1 1 61E7482D
P 3200 1450
AR Path="/61A00C0D/61E7482D" Ref="#PWR?"  Part="1" 
AR Path="/61E7482D" Ref="#PWR0147"  Part="1" 
F 0 "#PWR0147" H 3200 1300 50  0001 C CNN
F 1 "+12V" V 3200 1550 50  0000 L CNN
...
U 1 1 61EA0276
P 5700 1200
AR Path="/61A00C0D/61EA0276" Ref="JP?"  Part="1" 
AR Path="/61EA0276" Ref="JP7"  Part="1" 
F 0 "JP7" H 5750 1250 50  0000 L CNN
F 1 "SolderJumper_2_Open" V 5745 1268 50  0001 L CNN
...
U 1 1 61EAD617
P 5850 1200
AR Path="/61A00C0D/61EAD617" Ref="#PWR?"  Part="1" 
AR Path="/61EAD617" Ref="#PWR0148"  Part="1" 
F 0 "#PWR0148" H 5850 1050 50  0001 C CNN
...
U 1 1 61E97F8A
P 4700 1200
AR Path="/61A00C0D/61E97F8A" Ref="JP?"  Part="1" 
AR Path="/61E97F8A" Ref="JP6"  Part="1" 
F 0 "JP6" H 4750 1250 50  0000 L CNN
F 1 "SolderJumper_2_Open" V 4745 1268 50  0001 L CNN
F 2 "Jumper:SolderJumper-2_P1.3mm_Open_RoundedPad1.0x1.5mm" H 4700 1200 50  0001 C CNN
F 3 "~" H 4700 1200 50  0001 C CNN
	1    4700 1200
	-1   0    0    -1  
$EndComp
Wire Notes Line
	7700 5800 11200 5800
Wire Notes Line
	7700 500  7700 5800
Wire Notes Line
	4200 1650 4200 500 
